...
<custom-element-demo>
  <template>
    <script defer src=https://unpkg.com/graphviz-webcomponent@2.0.0/dist/graph.min.js></script>
...
```html
<script src=https://unpkg.com/graphviz-webcomponent@2.0.0/dist/index.min.js></script>
...
graphvizWebComponent = {
  rendererUrl: 'https://unpkg.com/graphviz-webcomponent@2.0.0/dist/index.min.js',
...
```html
<script src=https://unpkg.com/graphviz-webcomponent@2.0.0/dist/index-bundled.min.js></script>
