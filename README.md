...
<custom-element-demo>
  <template>
    <script defer src=https://unpkg.com/graphviz-webcomponent@1.2.3/dist/graph.min.js></script>
...
```html
<script src=https://unpkg.com/graphviz-webcomponent@1.2.3/dist/index.min.js></script>
...
graphvizWebComponent = {
  rendererUrl: 'https://unpkg.com/graphviz-webcomponent@1.2.3/dist/index.min.js',
...
```html
<script src=https://unpkg.com/graphviz-webcomponent@1.2.3/dist/index-bundled.min.js></script>
